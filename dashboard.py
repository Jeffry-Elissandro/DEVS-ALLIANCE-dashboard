...
with st.expander("🎧 Música ambiental (opcional)", expanded=False):
    ...
    # Incluimos los estilos para los botones
    styles = """
    <style>
    .music-buttons {
        display: flex;
    ...
    # Botones para seleccionar la música
    buttons_html = """
    ...
    # Script JavaScript para cambiar la fuente y reproducir
    script = """
    <script>
    ...
    # Combinar todo en un solo bloque HTML
