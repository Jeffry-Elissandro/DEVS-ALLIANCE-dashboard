...
# Generar las posiciones aleatorias para las partículas
num_particles = 9
positions = [random.randint(0, 100) for _ in range(num_particles)]
delays = [i * 2 for i in range(num_particles)]  # retrasos escalonados
...
# Crear las partículas con posiciones aleatorias y retrasos escalonados
html_particles = ""
