...
st.markdown(
    ...
    .colider-card {{
      ...
      margin:60px auto;
      padding:32px;
      background:linear-gradient(145deg,#0f172a,#1e293b 60%,#111827);
      border-radius:24px;
    ...
    <div class="colider-card">
      ...
      <div>
        <h3 class="colider-title">👑 ¡Ascenso Épico a Colíder!</h3>
        <p class="colider-text">
          Este logro no es casualidad, es el fruto de <strong>valor, disciplina y liderazgo</strong>.
          <br><br>
          Has demostrado que la verdadera fuerza está en la <em>perseverancia</em> y en el apoyo inquebrantable
          a la alianza en cada batalla.
          <br><br>
          Hoy celebramos tu ascenso con orgullo, porque tu ejemplo inspira a todos.
        </p>
        <div class="colider-rank">
          ✨ Felicitaciones — tu nombre queda marcado en la historia ✨
        </div>
      </div>
    </div>
    """,
...
puntaje_actual = 14685   # Oro actual
