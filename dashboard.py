...
.x:nth-child(1){ left: 10%; animation-delay: 0s; }
.x:nth-child(2){ left: 20%; animation-delay: 2s; }
.x:nth-child(3){ left: 30%; animation-delay: 4s; }
.x:nth-child(4){ left: 40%; animation-delay: 6s; }
.x:nth-child(5){ left: 50%; animation-delay: 8s; }
.x:nth-child(6){ left: 60%; animation-delay: 10s; }
.x:nth-child(7){ left: 70%; animation-delay: 12s; }
.x:nth-child(8){ left: 80%; animation-delay: 14s; }
.x:nth-child(9){ left: 90%; animation-delay: 16s; }
