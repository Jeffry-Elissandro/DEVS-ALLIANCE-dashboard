...
puntaje_actual = 16305   # Oro actual
...
f'    <div class="slide"><img src="data:image/png;base64,{img2}" onclick="openModal(data:image/png;base64,{img2}, PEACOCK"><div class="title">PEACOCK (Patricia)</div><div class="desc">Sel Beilschmidt (LadyNoireSel)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img3}" onclick="openModal(data:image/png;base64,{img3}, NADIA (MS.) FORTUNE"><div class="title">NADIA "MS." FORTUNE</div><div class="desc">unknown owner</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img4}" onclick="openModal(data:image/png;base64,{img4}, DOUBLE"><div class="title">DOUBLE (Agatha)</div><div class="desc">NnDi (ekativa1410)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img5}" onclick="openModal(data:image/png;base64,{img5}, FILIA"><div class="title">FILIA</div><div class="desc">Randal my beloved (Cerebellaspostins)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img6}" onclick="openModal(data:image/png;base64,{img6}, PARASOUL"><div class="title">PARASOUL</div><div class="desc">szuffp</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img7}" onclick="openModal(data:image/png;base64,{img7}, VALENTINE"><div class="title">VALENTINE</div><div class="desc">pularikk (pukarkalele)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img8}" onclick="openModal(data:image/png;base64,{img8}, SQUIGLY"><div class="title">SQUIGLY (Sienna Contiello)</div><div class="desc">Melodie !! (panconqueso_089)</div></div>'
...
f'    <div class="slide"><img src="data:image/png;base64,{img10}" onclick="openModal(data:image/png;base64,{img10}, PAINWHEEL"><div class="title">PAINWHEEL (Carol)</div><div class="desc">˖Nosferatzz (RaphiLLL)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img11}" onclick="openModal(data:image/png;base64,{img11}, BEOWULF"><div class="title">BEOWULF</div><div class="desc">unknown owner</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img12}" onclick="openModal(data:image/png;base64,{img12}, ELIZA"><div class="title">ELIZA</div><div class="desc">sanzhaana0236</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img13}" onclick="openModal(data:image/png;base64,{img13}, ROBO FORTUNE"><div class="title">ROBO FORTUNE</div><div class="desc">クミ 𓂃 ✒️ ωω𝗑𝗌𝗄𝗂 、zZz (wwxski)</div></div>'
f'    <div class="slide"><img src="data:image/png;base64,{img14}" onclick="openModal(data:image/png;base64,{img14}, DAHLIA"><div class="title">BLACK DAHLIA</div><div class="desc">ELLIE OCTC (Ellie_octc)</div></div>'
